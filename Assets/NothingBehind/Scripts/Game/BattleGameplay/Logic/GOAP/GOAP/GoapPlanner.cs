...
namespace NothingBehind.Scripts.Game.BattleGameplay.Logic.GOAP.GOAP
{
            ...
            HashSet<KeyValuePair<string, object>> goal)
        {
            ...
            foreach (GoapAction action in usableActions)
            {
                ...
                if (InState(action.Preconditions, parent.State))
                {
                    ...
                    if (GoalIsInState(goal, currentState))
                    {
                        // we found a solution!
                        leaves.Add(node);
                        foundOne = true;
	 ...
	 */
        ...
        private bool GoalIsInState(HashSet<KeyValuePair<string, object>> goal,
