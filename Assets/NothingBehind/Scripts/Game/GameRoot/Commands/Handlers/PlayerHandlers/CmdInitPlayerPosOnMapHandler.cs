...
namespace NothingBehind.Scripts.Game.GameRoot.Commands.Handlers.PlayerHandlers
{
        ...
        private void InitialPlayerPosition(CmdInitPlayerPosOnMap command)
        {
            ...
            else
            {
                var initialStateSettings =
                    _gameSettings.MapsSettings.Maps.First(m => m.MapId == _gameState.CurrentMapId.Value).InitialMapSettings;
