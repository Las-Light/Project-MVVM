...
namespace NothingBehind.Scripts.Game.Gameplay.Services.Hero
{
    public class MoveHeroService
    {
        ...
        public MoveHeroService(HeroSettings heroSettings,
        ...
        public void Move()
        {
            ...
            else
            {
                if (_inputManager.IsAim.CurrentValue)
                {
                    //_humanAnimatorController.AimMove(0, 0);
                }
                else
                {
                    //_humanAnimatorController.Move(_speedBlend);
                }
            }
        }
        ...
        private void MoveAimDirection(Vector2 movementDirection)
        {
            ...
            //_humanAnimatorController.AimMove(_speedBlendX, _speedBlendY);
        }
        ...
        private void SwitchSpeed(Vector2 movementDir)
        {
            ...
            else if (_inputManager.IsSprint.CurrentValue)
            {
                ...
                //  _inputManager.IsCrouch = false;
                // _humanAnimatorController.Crouch(_playerData.IsCrouch);
            }
            // else if (_inputManager.IsCrouch)
            // {
        ...
        private void FreeFall()
        {
            if (_grounded)
            {
                ...
                // update animator if using character
                //_humanAnimatorController.FreeFall(false);
            }
            else
            {
                // fall timeout
                ...
                {
                    // update animator if using character
                    //_humanAnimatorController.FreeFall(true);
                }
            }
        ...
        private void GroundedCheck()
        {
            ...
            // update animator if using character
            //_humanAnimatorController.Grounded(_grounded);
        }
    }
}