...
{
    public class GlobalMapTransferService
    {
        private readonly ObservableList<GlobalMapTransferViewModel> _mapTransfers = new();
        private readonly Dictionary<MapId, GlobalMapTransferViewModel> _mapTransfersMap = new();

        public IObservableCollection<GlobalMapTransferViewModel> MapTransfers => _mapTransfers;

        public GlobalMapTransferService(
        ...
        {
            var mapTransferViewModel = new GlobalMapTransferViewModel(mapTransferData);
