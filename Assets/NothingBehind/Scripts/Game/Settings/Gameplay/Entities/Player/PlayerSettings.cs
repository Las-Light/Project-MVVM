...
{
    [CreateAssetMenu(fileName = "PlayerSettings", menuName = "Game Settings/Entities/Characters/New Player Settings")]
    public class PlayerSettings : EntitySettings<PlayerLevelSettings>
    {
